...
class Book:
    ...
    def __setattr__(self, attr, value):
        if attr == 'book_id' or attr == 'book_name' or attr == 'book_author' or attr == 'book_publishing_house' or attr == 'book_year' or attr == 'book_pages' or attr == 'book_price' or attr == 'book_binding_type':
            self.__dict__[attr] = value
        else:
            print('Object Book doesn\'t have such attribute = ' + attr)
            raise AttributeError

    def __lt__(self, other):
        return self.book_year < other.book_year
...
def create_new_book():
    ...
    book = Book(book_id, book_name, book_author, book_publishing_house, book_year, book_pages, book_price,
                book_binding_type)
...
# a = Book(1, '1', '1', '1', 1, 1, 1, '1')
# b = Book(1, '1', '1', '1', 1, 1, 1, '1')
# print(a)
# print(b)
# print(a==b)
# a.book_id
# a.book_id2 = 15
# print(str(a.book_id2))
